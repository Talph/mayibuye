                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    <div class="col-md-8">
                                        ...
                                        <input class="form-control"  hidden type="text" name="id" value="{{ $client->id }}" required>
                                        <input class="form-control" type="text" placeholder="{{ __('client name') }}"
                                            name="client_name" value="{{ $client->client_name }}" required autofocus>
                                    </div>
                                    <div class="col-md-4 mt-3">
                                    <div class="img-container text-center mt-2" id="">
                                        <img src="{{$client->getFirstMediaUrl('logos')}}" width="150" alt="{{$client->client_name}}">
                                            <p>
                                                            click to change
                                            </p>
                                        </div>
          ...
          <button type="button" class="btn btn-primary">upload</button>
                        ...
                        <div class="form-group row">
                                ...
                                <textarea class="form-control" id="summernote" name="client_desc" rows="9"
                                    placeholder="{{ __('Content..') }}" required> {{ $client->client_desc }}</textarea>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                <div class="col">
                                    ...
                                    <input data-role-id="{{$solution->id}}" id="solution{{$solution->id}}" data-role-slug="{{$solution->solution_slug}}"
                                        value="{{$solution->id}}" 
