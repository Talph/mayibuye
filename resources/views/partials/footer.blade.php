...
<footer class="footer py-5 bg-dark-ci">
    <div class="container">
    <div class="row">
      ...
      <div class="col-12 col-md">
        ...
        <ul class="list-unstyled text-small">
          <li class="mb-3">Masters in construction indusrty with 10 years of experience.</li>
      ...
      <div class="col-12 col-md">
        ...
        <ul class="list-unstyled text-small">
            ...
            <a class="ml-3" aria-label="Mayibuye Youtube" title="Youtube" href="https://www.youtube.com/channel/UCXgLqVdDuG7Do-yMr8RJ0KA" rel="noopener noreferrer" target="_blank"><i style="width:100px" class="ms bi bi-youtube"></i></a></li>
        </ul>
      </div>
      <div class="col-12 col-md">
