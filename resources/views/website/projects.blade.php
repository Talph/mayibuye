...
<div class="col-md-6">
    <div class="content">
        <div class="title font-italic">Project title: {!! ($arrow)!!}</div>
    <div class="title-top"><h5 class="font-weight-bold">Ibika-Centane Bulk Water Supply and reticulation</h5></div>
    <div class="p proj-summary font-italic">Summary: {!! ($arrow)!!}</div><div class="text desc-proj">
    ...
    <div class="proj__client font-italic">Client: {!! ($arrow)!!}</div><div class="client text proj__client">
...
<div class="project-section-second mt-5 shadow">
    ...
    <div class="col-md-6">
        ...
        <div class="p proj-summary font-italic">Summary: {!! ($arrow)!!}</div>
        <div class="text desc-proj">
            ...
            <div class="proj__client font-italic">Client: {!! ($arrow)!!}</div>
